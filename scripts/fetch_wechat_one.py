...
og_t = re.search(r'<meta property="og:title" content="([^"]+)"', raw)
og_d = re.search(r'<meta property="og:description" content="([^"]+)"', raw)
og_i = re.search(r'<meta property="og:image" content="([^"]+)"', raw)
