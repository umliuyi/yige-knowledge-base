...
url = 'https://mp.weixin.qq.com/s/Y7sDiAXFYbKqFEWMsEjKnQ'
headers = {
...
if m:
    ...
    out = r'C:\Users\Administrator\.openclaw-autoclaw\workspace\wechat_article5.txt'
...
for i, u in enumerate(unique):
    try:
        ...
        data = iv.read()
        if len(data) > 10000:
            out = r'C:\Users\Administrator\.openclaw-autoclaw\workspace\wechat5_img_%d.jpg' % i
...
print('Saved %d images > 10KB' % len(saved))
for i, sz in saved:
    print('  img_%d.jpg - %dKB' % (i, sz//1024))
