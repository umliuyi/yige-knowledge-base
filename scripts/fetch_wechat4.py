...
url = 'https://mp.weixin.qq.com/s/9gWQ3ptFubZCLNus0ojZVA'
headers = {
...
if m:
    ...
    out = r'C:\Users\Administrator\.openclaw-autoclaw\workspace\wechat_article4.txt'
...
for i, u in enumerate(unique):
    try:
        ...
        data = iv.read()
        if len(data) > 10000:
            out = r'C:\Users\Administrator\.openclaw-autoclaw\workspace\wechat4_img_%d.jpg' % i
            with open(out, 'wb') as f:
                f.write(data)
            saved.append((i, len(data), out))
    except:
        pass
print(f'Saved {len(saved)} images > 10KB')
for i, sz, path in saved:
    print(f'  wechat4_img_{i}.jpg - {sz//1024}KB')
