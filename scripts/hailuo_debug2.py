...
endpoints_to_try = [
    ...
    f"https://api.minimaxi.com/v1/video_generation?task_id={task_id}",
    f"https://api.minimaxi.com/v1/video/{task_id}",
    f"https://api.minimaxi.com/v1/videos/{task_id}",
    f"https://api.minimax.com/v1/video_generation/{task_id}",
    f"https://api.minimax.com/v1/video_generation/{task_id}",
]
